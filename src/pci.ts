...
export class PCI
{
    private pci_addr = new Uint8Array(4);
    private pci_value = new Uint8Array(4);
    private pci_response = new Uint8Array(4);
    private pci_status = new Uint8Array(4);

    private pci_addr32 = new Int32Array(this.pci_addr.buffer);
    private pci_value32 = new Int32Array(this.pci_value.buffer);
    private pci_response32 = new Int32Array(this.pci_response.buffer);
    private pci_status32 = new Int32Array(this.pci_status.buffer);

    private device_spaces: any[] = [];
    private devices: any[] = [];
    private original_bars: any[] = [];
    ...
    constructor(cpu: CPU)
    {
        ...
        cpu.io.register_write_consecutive(PCI_CONFIG_ADDRESS, this,
            (out_byte) => this.pci_addr[0] = out_byte,
            (out_byte) => this.pci_addr[1] = out_byte,
            (out_byte) => this.pci_addr[2] = out_byte,
            (out_byte) => { this.pci_addr[3] = out_byte; this.pci_query(); }
        );
    ...
    public move_io_bars(from, to, count)
    {
