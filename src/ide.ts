...
function hex_dump(buffer, length: number)
{
    var result = [];
...
{
    private master: IDEInterface;
    private slave: IDEInterface;
    private current_interface: IDEInterface;

    private ata_port: number;
    private irq: number;
    private pci_id: number;

    private ata_port_high: number;
    private master_port: number;

    private pci_space: number[];
    private pci_bars: any[];

    private name: string;
    private device_control: number;

    private prdt_addr = 0;
    private dma_status = 0;
    ...
    constructor(
        private cpu: CPU, buffer: any, is_cd: boolean, nr: number, bus: BusConnector)
    {
        ...
        // status
        cpu.io.register_read(this.ata_port | 7, this, () => {
        ...
        cpu.io.register_read(this.ata_port | 0, this, 
            ...
            () => this.current_interface.read_data(4));

        cpu.io.register_read(this.ata_port | 1, this, () =>
        {
        ...
        cpu.io.register_write(this.ata_port | 2, this, (data) =>
        {
        ...
        cpu.io.register_write(this.ata_port | 3, this, (data) =>
        {
        ...
        cpu.io.register_write(this.ata_port | 4, this, (data) =>
        {
        ...
        cpu.io.register_write(this.ata_port | 5, this, (data) =>
        {
        ...
        cpu.io.register_write(this.ata_port | 6, this, (data) =>
        {
            var slave = data & 0x10;
            var mode = data & 0xE0;
        ...
        cpu.io.register_write(this.ata_port | 7, this, (data) =>
        {
            dbg_log("lower irq", LOG_DISK);
            this.cpu.device_lower_irq(this.irq);
    ...
    public dma_write_command8(value)
    {
...
export class IDEInterface
{
    ...
    private is_atapi: boolean;

    private sector_count: number = 0;
    private head_count: number = 0;
    private sectors_per_track: number = 0;
    private cylinder_count: number = 0;

    public is_lba = 0;
    public bytecount = 0;
    public sector = 0;
    public lba_count = 0;
    public cylinder_low = 0;
    public cylinder_high = 0;
    public head = 0;
    public drive_head = 0;
    public status = 0x50;
    private sectors_per_drq = 0x80;
    public error = 0;
    private data_pointer = 0;

    private data = new Uint8Array(64 * 1024);
    private data16 = new Uint16Array(this.data.buffer);
    private data32 = new Int32Array(this.data.buffer);

    private data_length = 0;
    private data_end = 0;
    public current_command = -1;
    public current_atapi_command = -1;
    private write_dest = 0;
    ...
    public write_data_port(data, length)
    {
    ...
    public write_data_port8(data)
    {
        this.write_data_port(data, 1);
    };

    public write_data_port16(data)
    {
        this.write_data_port(data, 2);
    };

    public write_data_port32(data)
    {
    ...
    public ata_advance(cmd, sectors)
    {
    ...
    public ata_read_sectors_dma(cmd)
    {
    ...
    public do_ata_read_sectors_dma()
    {
    ...
    public ata_write_sectors_dma(cmd)
    {
    ...
    public do_ata_write_sectors_dma()
    {
        dbg_assert(!!this.is_lba, "TODO");
    ...
    public data_allocate_noclear(len)
    {
    ...
    public report_read_start()
    {
        this.stats.loading = true;
        this.bus.send("ide-read-start");
    };

    public report_read_end(byte_count)
    {
    ...
    public report_write(byte_count)
    {
        var sector_count = byte_count / this.sector_size | 0;
