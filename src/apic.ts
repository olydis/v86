...
{
    private cpu: CPU;
    private ioredtlb: Int32Array;

    private irqs: any[];
    private ioapic_id: number;

    private lapic_tpr: number;
    private lapic_icr: Int32Array;

    private iotable: Int32Array;
    ...
    public ioapic_write(reg, value): void
    {
